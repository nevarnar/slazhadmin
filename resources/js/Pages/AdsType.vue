<template>
    <div class="inner-main-container">
        <div>
            <p class="page-tittle">Ads Type Management</p>
        </div>
        ...
        <div class="block pb-8">
            <table class="primary-table">
                ...
                <tbody>
                    <tr v-for="ads_type in myAdsType" :key="ads_type.id">
                        <td>
                            {{ ads_type.index }}
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            <button
                                ...
                                title="Edit"
                                id="edit-button"
                                @click="open_edit_modal(ads_type.id)"
                                :disabled="disabled"
                            >
                                <i
...
export default {
    ...
    data() {
        return {
            typeOfSearch: "ads_type",
            mutationName: "setAdsTypes",
            formData: {
                id: "",
                name:"",
            },
    ...
    computed: {
        ...mapGetters(["myAdsType", "getisEditing", "currentApiLoading"]),
    },
    methods: {
        ...mapActions([
            "getPaginatedData",
        ...
        open_edit_modal(ads_type_id) {
            this.validationMsg.name = null;
            this.setisEditing(true);
            axios
                .get(`/ads_type_list/${ads_type_id}`)
                .then((res) => {
