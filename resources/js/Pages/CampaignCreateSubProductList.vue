<template>
    <div class="w-full">
        <table class="secondary-table">
            ...
            <tbody>
                <tr
                    v-for="(stock, index) in getDiscountSubProducts"
                    :key="index"
                >
...
<script>
    ...
    export default {
        name: "CampaignCreateSubProductList",
        computed: {
            ...mapGetters(["getDiscountSubProducts"]),
        },
        methods: {
            ...mapMutations(["removeDiscountSubProductRow"]),
                calPrice(stock){
                ...
                this.$swal({
                    ...
                    if (result.value) {
                        this.removeDiscountSubProductRow(stock.local_id);
                    } else {
